...
echo "2 - Enter  linaro into path"

echo "3 - Download the prerequirements"

echo "4 - Create the structure of the chrooted system"

echo "5 - Create the raw image"

echo "5.1 - Mount raw image system"
